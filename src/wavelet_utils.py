...
paths=[os.path.join(_IMG_DIR, name) for name in ["digital_checkered.png","satellite_image.jpg","normal.jpg","pattern.jpg"]] #kullanılacak resim
...
show_subbands_of_wavelet(os.path.join(_IMG_DIR, "aybu.jpg"),WAVELET_NAMES[0])